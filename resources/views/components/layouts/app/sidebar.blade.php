        ...
        <div class="h-full flex flex-col">
            <nav class="flex-1 overflow-y-auto custom-scrollbar py-4">
                <ul class="space-y-3 px-2">
                    ...
                    {{-- Example --}}
                    <x-sidebar.level-two-parent title="Subscription" icon="fa-solid fa-rocket-launch"
                        :active="request()->routeIs('settings.profile.edit') || request()->routeIs(patterns: 'settings.profile.edit')">
                        <x-sidebar.level-two-link href="{{ route('settings.profile.edit') }}"
                            icon='fa-duotone fa-light fa-sliders' :active="request()->routeIs('settings.profile.edit')">
                            Plans
                    ...
                    <x-sidebar.level-two-parent title="Example three level" icon="fa-duotone fa-light fa-sliders"
                        ...
                        <x-sidebar.level-three-parent title="Third Level" icon="fa-duotone fa-light fa-sliders"
                            :active="request()->routeIs('settings.profile.edit')">
